...
public class DRCSimulationTestHelper
{
                                  ...
                                  CommonAvatarEnvironmentInterface testEnvironment)
   {
      ...
      defaultControllerPublishers.put(FingerTrajectoryMessage.class, createPublisherForController(FingerTrajectoryMessage.class));
      defaultControllerPublishers.put(HandDesiredConfigurationMessage.class, createPublisherForController(HandDesiredConfigurationMessage.class));
   }
